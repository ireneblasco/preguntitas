export const it = {
  ...
  players: {
    ...
    subtitle:
      'Aggiungi i nomi dei partecipanti così ogni domanda può essere assegnata a qualcuno.',
    momentLabel: 'Momento',
    ...
    skip: 'Salta',
    remove: 'Rimuovi',
    removeHint: 'Rimuove questa persona dall’elenco',
    clearHint: 'Cancella questo nome',
  },
  favorites: {
    title: 'Salvati',
